...
export const userFacebookReducer = (state = {}, action) =>{

    switch (action.type){

        case USER_FACEBOOK_REQUEST : return { loading: true}

        case USER_FACEBOOK_SUCCESS : return { loading: false, userInfo: action.payload}

        case USER_FACEBOOK_FAIL : return { loading: false, error: action.payload} 
...
export const userListReducer = (state = { users: [] }, action) => {
  switch (action.type) {
    ...
    case USER_LIST_SUCCESS: return { loading: false, users: action.payload.users, pages: action.payload.pages, page: action.payload.page }
...
export const userAvisReducer = (state = { Avis: {avis: []} }, action) => {

  switch (action.type) {

    case USER_AVIS_REQUEST: return { loading: true, ...state }

    case USER_AVIS_SUCCESS: return { loading: false, Avis: action.payload }

    case USER_AVIS_FAIL: return { loading: false, error: action.payload }
...
export const createAvisReducer = (state = { Avis: { avis: [] } }, action) => {

  switch (action.type) {

    case CREATE_AVIS_REQUEST: return { loading: true, ...state }

    case CREATE_AVIS_SUCCESS: return { loading: false, Avis: action.payload }

    case CREATE_AVIS_FAIL: return { loading: false, error: action.payload }
