...
export const productNouveauxReducer = (state = { products: [] }, action) => {
  switch (action.type) {

    case CREATEDAT_PRODUCTS_REQUEST: return { loading: true, products: [] }

    case CREATEDAT_PRODUCTS_SUCCESS: return { loading: false, products: action.payload }

    case CREATEDAT_PRODUCTS_FAIL: return { loading: false, error: action.payload }

    default: return state 
  }
}

export const navabarReducer = (state = { products: [] }, action) => { 
  switch (action.type) {

    case PRODUCT_NAVBAR_REQUEST: return { loading: true, products: [] }

    case PRODUCT_NAVBAR_SUCCESS: return { loading: false, products: action.payload.products, pages: action.payload.pages, page: action.payload.page }

    case PRODUCT_NAVBAR_FAIL: return { loading: false, error: action.payload }
